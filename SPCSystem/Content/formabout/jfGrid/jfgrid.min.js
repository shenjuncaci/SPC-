...
0;a._headHeight=0;a._colModel=[];a._colFrozenModel=[];for(var c=e('<div class="jfgrid-head" id="jfgrid_head_'+a.id+'" ></div>'),d=e('<div class="jfgrid-border" id="jfgrid_border_'+a.id+'" ></div>'),f=e('<div class="jfgrid-border-col" id="jfgrid_border_col_'+a.id+'" ></div>'),h=a.headData.length,k=0;k<h;k++){var g=a.headData[k],p=g.frozen?a._leftWidth:a._headWidth;g.height=28;var l=e('<div class="jfgrid-head-cell jfgrid-heed-rownum_0" path="'+k+'" >'+(g.label||"")+"</div>");g.obj=l;g.path=k;g.children?
g.frozen?e.jfGrid.renderSubHead(f,g,a,a._leftWidth,1,!0,k):e.jfGrid.renderSubHead(c,g,a,a._headWidth,1,!1,k):(l.attr("jfgrid-heed-cellrender","ok"),l.append('<div class="jfgrid-heed-sort"><i class="fa fa-caret-up"></i><i class="fa fa-caret-down"></i></div>'),l.append('<div class="jfgrid-heed-move"></div>'),g.frozen?a._colFrozenModel[a._colFrozenModel.length]=g:a._colModel[a._colModel.length]=g,g.type="datacol");g.left=p;l.css({width:(g.width||100)+"px","text-align":g.align||"left",left:p+"px"});a._headHeight=
a._headHeight>g.height?a._headHeight:g.height;g.frozen?(a._leftWidth+=g.width,f.append(l)):(a._headWidth+=g.width,c.append(l))}if(28<a._headHeight)for(c.find('.jfgrid-heed-rownum_0[jfgrid-heed-cellrender="ok"]').css({height:a._headHeight+"px","line-height":a._headHeight-1+"px"}),f.find('.jfgrid-heed-rownum_0[jfgrid-heed-cellrender="ok"]').css({height:a._headHeight+"px","line-height":a._headHeight-1+"px"}),k=0;k<h;k++)g=a.headData[k],g.children&&g.height<a._headHeight&&(g.children?e.jfGrid.renderSubHeadToo(g.children,
a._headHeight-g.height):g.obj.css({height:a._headHeight-g.height+28+"px","line-height":a._headHeight-g.height+27+"px"}));d.append(f);b.append(d);b.append(c)},renderSubHead:function(b,a,c,d,f,h,k){a.width=0;for(var g=a.children,p=g.length,l=28,q=0;q<p;q++){var m=g[q];m.height=28;m.parent=a;var n=e('<div class="jfgrid-head-cell jfgrid-heed-rownum_'+f+'" path="'+k+"."+q+'" >'+(m.label||"")+"</div>");m.obj=n;m.path=q;m.children?e.jfGrid.renderSubHead(b,m,c,d+a.width,f+1,h,k+"."+q):(n.attr("jfgrid-heed-cellrender",
"ok"),n.append('<div class="jfgrid-heed-sort"><i class="fa fa-caret-up"></i><i class="fa fa-caret-down"></i></div>'),n.append('<div class="jfgrid-heed-move"></div>'),h?(m.frozen=!0,c._colFrozenModel[c._colFrozenModel.length]=m):c._colModel[c._colModel.length]=m,m.type="datacol");m.left=d+a.width;n.css({width:(m.width||100)+"px","text-align":m.align||d,left:d+a.width+"px",top:28*f+"px"});a.width+=m.width;l=m.height>l?m.height:l;b.append(n)}28<l&&b.find(".jfgrid-heed-rownum_"+f+'[jfgrid-heed-cellrender="ok"]').css({height:l+
"px","line-height":l-1+"px"});a.height+=l},renderSubHeadToo:function(b,a){for(var c=b.length,d=0;d<c;d++){var f=b[d].obj;b[d].children?e.jfGrid.renderSubHeadToo(b[d].children,a):f.css({height:a+b[d].height+"px","line-height":b[d].height+a-1+"px"})}},renderBorder:function(b){var a=b[0].dfop,c=b.find("#jfgrid_border_"+a.id),d=b.find("#jfgrid_head_"+a.id),f=0;if(a.isShowNum){var h=e('<div class="jfgrid-border-cell jfgrid-border-num"></div>');c.prepend(h);f+=30}a.isMultiselect&&(h=e('<div class="jfgrid-border-cell jfgrid-border-cb"><input role="checkbox" id="jfgrid_all_cb_'+
a.id+'" type="checkbox"></div>').css("left",f+"px").css("line-height",a._headHeight-1+"px"),c.prepend(h),f+=30);a.isSubGrid&&(h=e('<div class="jfgrid-border-cell jfgrid-border-sub"></div>').css("left",f+"px"),c.prepend(h),f+=30);a._borderLeftPadding=f;a._leftWidth+=f;c.css({width:a._leftWidth+"px",height:a._headHeight+"px","padding-left":f+"px"});d.css({width:a._headWidth+"px",height:a._headHeight+"px",left:a._leftWidth+"px"});b.css({"padding-left":a._leftWidth+"px","padding-top":a._headHeight+"px"})},
...
l;f++)c[f]||g.push(a.rowdatas[f]);0==g.length&&g.push({});a.rowdatas=g;e.jfGrid.renderData(b)}else top.Excalibur.alert.warning("\u8bf7\u9009\u62e9\u9700\u8981\u5220\u9664\u7684\u884c!")});c.append(d);c.append(f);b.append(c)}},renderStatistics:function(b){var a=b[0].dfop;if(a.isStatistics){var c=b.find("#jfgrid_footerrow_"+a.id);b=c.find("#jfgrid_statistics_"+a.id);0==b.length&&(b=e('<div class="jfgrid-statistics" id="jfgrid_statistics_'+a.id+'" ></div>'),c.append(b),b.css({width:a._headWidth+"px",left:a._leftWidth+
"px"}));b.html("");for(var c=-1,d,f=0,h=a._colModel.length;f<h;f++){var k=a._colModel[f],g=0;if(k.statistics){-1==c&&(c=0,d&&d.html("\u5408\u8ba1:"));d=0;for(var p=a.rowdatas.length;d<p;d++){var l=a.rowdatas[d];void 0!=l[k.name]&&null!=l[k.name]&&""!=l[k.name]&&(g+=parseFloat(l[k.name]))}}d=e('<div class="jfgrid-data-cell"  colname="'+k.name+'" style="width:'+k.width+"px;text-align:"+k.align+';" ></div>');k.statistics&&(d.html(g),d.attr("title",k.label));b.append(d)}}},renderStatisticsOne:function(b,
a){var c=b[0].dfop;if(c.isStatistics){b=b.find("#jfgrid_statistics_"+c.id);for(var d=0,e=0,h=c.rowdatas.length;e<h;e++){var k=c.rowdatas[e];void 0!=k[a]&&null!=k[a]&&""!=k[a]&&(d+=parseFloat(k[a]))}b.find('[colname="'+a+'"]').html(d)}},reload:function(b){var a=b[0].dfop;a.rowdatas=[];a.isPage?(a.pageparam.page=1,a.pageparam.records=0,a.pageparam.total=0,a.param.pagination=JSON.stringify(a.pageparam),e.jfGrid.ajaxLoad(b,a.url,a.param,function(c){200==c.code?(a.rowdatas=c.data.rows,a.pageparam.page=
c.data.page,a.pageparam.records=c.data.records,a.pageparam.total=c.data.total):(a.rowdatas=[],a.pageparam.page=1,a.pageparam.records=0,a.pageparam.total=0);e.jfGrid.renderData(b);if(a.onRenderComplete)a.onRenderComplete(c.data.rows)})):e.jfGrid.ajaxLoad(b,a.url,a.param,function(c){a.rowdatas=200==c.code?c.data:[];e.jfGrid.renderData(b);if(a.onRenderComplete)a.onRenderComplete(a.rowdatas)})},reloadPage:function(b){var a=e(this),c=e("#"+a.attr("id").replace("jfgrid_page_bar_num_","")),d=c[0].dfop;b=
e(b.target||b.srcElement);if(b.hasClass("pagebtn")){var f=parseInt(b.text());f!=d.pageparam.page&&(a.find(".active").removeClass("active"),b.addClass("active"),d.pageparam.page=f,d.param.pagination=JSON.stringify(d.pageparam),e.jfGrid.ajaxLoad(c,d.url,d.param,function(a){200==a.code&&(d.rowdatas=a.data.rows,d.pageparam.page=a.data.page,d.pageparam.records=a.data.records,d.pageparam.total=a.data.total);e.jfGrid.renderData(c)}))}},reloadPage2:function(b){var a=e(this),c=b.data.op,d=a.text();b=e("#jfgrid_page_bar_num_"+
c.id);var f=parseInt(b.find(".active").text());b=!1;switch(d){case "\u9996\u9875":1!=f&&(c.pageparam.page=1,b=!0);break;case "\u4e0a\u4e00\u9875":1<f&&(c.pageparam.page=f-1,b=!0);break;case "\u4e0b\u4e00\u9875":f<c.pageparam.total&&(c.pageparam.page=f+1,b=!0);break;case "\u5c3e\u9875":f!=c.pageparam.total&&(c.pageparam.page=c.pageparam.total,b=!0);break;case "\u8df3\u8f6c":if(a=a.parents("#jfgrid_page_bar_nums_"+c.id).find("input").val())a=parseInt(a),"NaN"!=String(a)&&(1>a&&(a=1),a>c.pageparam.total&&
(a=c.pageparam.total),c.pageparam.page=a,b=!0)}b&&(c.param.pagination=JSON.stringify(c.pageparam),e.jfGrid.ajaxLoad(e("#"+c.id),c.url,c.param,function(a){200==a.code&&(c.rowdatas=a.data.rows,c.pageparam.page=a.data.page,c.pageparam.records=a.data.records,c.pageparam.total=a.data.total);e.jfGrid.renderData(e("#"+c.id))}))},renderData:function(b){var a=b[0].dfop;a.isPage?(e.jfGrid.renderRowData(b,a.rowdatas),e.jfGrid.renderPageBar(b)):a.isTree?("tree"!=a.datatype&&(a.rowdatas=e.jfGrid.listTotree(a.rowdatas,
a.parentId,a.mainId,a)),e.jfGrid.renderTreeRowData(b,a.rowdatas)):e.jfGrid.renderRowData(b,a.rowdatas);e.jfGrid.renderStatistics(b)},renderRowData:function(b,a){var c=b[0].dfop,d=b.find("#jfgrid_left_"+c.id),f=b.find("#jfgrid_scrollarea_content_"+c.id),h=b.find("#jfgrid_nodata_img_"+c.id);h.hide();var k;c.reloadSelected&&!c.isMultiselect&&(k=e.jfGrid.getSelectedRow(b));d.html("");f.html("");a=a||[];for(var g=a.length,p=0;p<g;p++){var l=a[p],q=null,m="rownum_"+c.id+"_"+p;d.append('<div class="jfgrid-data-cell jfgrid-hide-cell" rownum="'+
m+'"  datapath="'+p+'" ></div>');if(c.isShowNum){var n=e('<div class="jfgrid-data-cell jfgrid-tool-cell" rownum="'+m+'" colname="jfgrid_rownum"  >'+(p+1)+"</div>");d.append(n);q=n}c.isMultiselect&&(n="",c.multiselectfield&&1==parseInt(l[c.multiselectfield])&&(n="checked"),n=e('<div class="jfgrid-data-cell jfgrid-tool-cell" rownum="'+m+'" colname="jfgrid_multiselect" ><input role="checkbox" type="checkbox" '+n+" ></div>"),d.append(n),q=n);c.isSubGrid&&(n=e('<div class="jfgrid-data-cell jfgrid-tool-cell" rownum="'+
m+'" colname="jfgrid_subGrid"><i class="fa fa-plus jfgrid_expend" rownum="'+m+'" ></i></div>'),d.append(n),q=n);for(var w=0,u=c._colFrozenModel.length;w<u;w++)n=e('<div class="jfgrid-data-cell" rownum="'+m+'"  colname="'+c._colFrozenModel[w].name+'" style="width:'+c._colFrozenModel[w].width+"px;text-align:"+c._colFrozenModel[w].align+';"  title="'+(l[c._colFrozenModel[w].name]||"")+'" ></div>'),w==u-1&&(q=n),e.jfGrid.getCellHtml(c._colFrozenModel[w],l,c,n,p),d.append(n);q&&q.addClass("jfgrid-data-cell-last");
q=0;for(w=c._colModel.length;q<w;q++)n=e('<div class="jfgrid-data-cell" rownum="'+m+'" colname="'+c._colModel[q].name+'" style="width:'+c._colModel[q].width+"px;text-align:"+c._colModel[q].align+';" title="'+(l[c._colModel[q].name]||"")+'"  ></div>'),q==w-1&&n.addClass("jfgrid-data-cell-last"),e.jfGrid.getCellHtml(c._colModel[q],l,c,n,p),f.append(n);c.reloadSelected&&!c.isMultiselect&&k&&l[c.mainId]==k[c.mainId]&&b.find('.jfgrid-data-cell[rownum="'+m+'"]').addClass("jfgrid-head-cell-selected").addClass("jfgrid_selected_"+
c.id)}0==g?h.show():c.isAutoHeight&&(a=28*g,d=b.css("padding-top"),c.footerrow&&!c.isPage&&(a=parseInt(a)+29),b.css({height:parseInt(a)+parseInt(d)+2}))},renderTreeRowData:function(b,a){function c(a,k,m){for(var l=0,q=a.length;l<q;l++){var u=a[l],y=e('<div class="jfgrid-data-cell-expend" style="width:'+16*k+'px;" ></div>');u.jfgrid_rownum=p;var x="rownum_"+d.id+"_"+p,t=null;f.append('<div class="jfgrid-data-cell jfgrid-hide-cell"  rownum="'+x+'"  datapath="'+m+l+'" ></div>');if(d.isShowNum){var r=
e('<div class="jfgrid-data-cell jfgrid-tool-cell" rownum="'+x+'" colname="jfgrid_rownum"  >'+(p+1)+"</div>");f.append(r);t=r}d.isMultiselect&&(r="",d.multiselectfield&&1==parseInt(u[d.multiselectfield])&&(r="checked"),r=e('<div class="jfgrid-data-cell jfgrid-tool-cell" rownum="'+x+'" colname="jfgrid_multiselect" ><input role="checkbox" type="checkbox" '+r+" ></div>"),f.append(r),t=r);d.isSubGrid&&(r=e('<div class="jfgrid-data-cell jfgrid-tool-cell" rownum="'+x+'" colname="jfgrid_subGrid"><i class="fa fa-plus jfgrid_expend" rownum="'+
x+'" ></i></div>'),f.append(r),t=r);for(var v=0,z=d._colFrozenModel.length;v<z;v++)r=e('<div class="jfgrid-data-cell" rownum="'+x+'"  colname="'+d._colFrozenModel[v].name+'" style="width:'+d._colFrozenModel[v].width+"px;text-align:"+d._colFrozenModel[v].align+';"  title="'+(u[d._colFrozenModel[v].name]||"")+'" >'+(u[d._colFrozenModel[v].name]||"")+"</div>"),e.jfGrid.getCellHtml(d._colFrozenModel[v],u,d,r,l),0==v&&r.prepend(y),v==z-1&&(t=r),f.append(r);t&&t.addClass("jfgrid-data-cell-last");t=0;for(v=
d._colModel.length;t<v;t++)r=e('<div class="jfgrid-data-cell" rownum="'+x+'" colname="'+d._colModel[t].name+'" style="width:'+d._colModel[t].width+"px;text-align:"+d._colModel[t].align+';" title="'+(u[d._colModel[t].name]||"")+'"  >'+(u[d._colModel[t].name]||"")+"</div>"),e.jfGrid.getCellHtml(d._colModel[t],u,d,r,l),0==t&&0==d._colFrozenModel.length&&r.prepend(y),t==v-1&&r.addClass("jfgrid-data-cell-last"),h.append(r);d.reloadSelected&&!d.isMultiselect&&g&&u[d.mainId]==g[d.mainId]&&b.find('.jfgrid-data-cell[rownum="'+
x+'"]').addClass("jfgrid-head-cell-selected").addClass("jfgrid_selected_"+d.id);p++;0<u.jfGrid_ChildRows.length&&(y.append('<i class="fa fa-caret-down jfgrid-data-cell-expendi"></i>'),c(u.jfGrid_ChildRows,k+1,m+l+"."))}}var d=b[0].dfop,f=b.find("#jfgrid_left_"+d.id),h=b.find("#jfgrid_scrollarea_content_"+d.id),k=b.find("#jfgrid_nodata_img_"+d.id),g;d.reloadSelected&&!d.isMultiselect&&(g=e.jfGrid.getSelectedRow(b));var p=0;k.hide();f.html("");h.html("");a=a||[];0<a.length?c(a,1,""):k.show();d=null},
renderPage:function(b){e("#jfgrid_page_bar_"+b.id);b._pagination&&1<b._pagination.total&&(e('<li title="\u4e0a\u4e00\u9875" ><a href="#" aria-label="\u4e0a\u4e00\u9875"><span aria-hidden="true">&laquo;</span></a></li>'),e('<li title="\u4e0b\u4e00\u9875"><a href="#" aria-label="\u4e0b\u4e00\u9875"><span aria-hidden="true">&raquo;</span></a></li>'))},getCellHtml:function(b,a,c,d,f){var h="",k=a[b.name];if(b.editType)switch(b.editType){case "input":h=e('<input  type="text" class="form-control" />').val(k||
"");h.css({"text-align":b.align});h.on("input propertychange",function(){var d=e(this);a[b.name]=d.val();b.statistics&&e.jfGrid.renderStatisticsOne(e("#"+c.id),b.name);b.editOp&&b.editOp.callback&&(b.editOp.callback(f,a),e.jfGrid.renderData(e("#"+c.id)),e('[rownum="rownum_'+c.id+"_"+f+'"][colname="'+b.name+'"]>input').focus())});d.html(h);b.formatter&&b.formatter(k,a,c,d);break;case "label":h=e('<span class="form-label" >'+(k||"")+"</span>");h.css({"text-align":b.align});d.html(h);break;case "select":h=
e('<div class="form-select" >'+(k||"")+'<i class="fa fa-ellipsis-h"></i></div>');h.css({"text-align":b.align});h.find(".fa-ellipsis-h")[0]._node=b;h.find(".fa-ellipsis-h").on("click",function(){console.log("cbb");var b=e(this)[0]._node;console.log(b);e.jfGrid.layer({html:'<div class="jfgird-select"><div class="jfgird-select-tool"><div class="jfgird-select-tool-item"><input id="jfgird_select_keyword" style="width:200px;" type="text" class="form-control" placeholder="\u8bf7\u8f93\u5165\u8981\u67e5\u8be2\u5173\u952e\u5b57"></div><div class="jfgird-select-tool-item"><a id="jfgird_select_search" class="btn btn-primary btn-sm"><i class="fa fa-search"></i>&nbsp;\u67e5\u8be2</a></div></div><div id="jfgird_select"></div></div>',
...
'"]').css("width",a._currentMoveCell.width+"px")},selectRow:function(b,a,c){var d=a,f=a.attr("rownum");f||(d=a.parents(".jfgrid-data-cell"),f=d.attr("rownum"));var h=".jfgrid_selected_"+c.id;c.isMultiselect?("checkbox"==a.attr("role")&&(d.hasClass("jfgrid-head-cell-selected")?(b.find(h+'[rownum="'+f+'"]').removeClass("jfgrid-head-cell-selected").removeClass("jfgrid_selected_"+c.id),e("#jfgrid_all_cb_"+c.id).is(":checked")&&(c._cancelallcb=!0,e("#jfgrid_all_cb_"+c.id).trigger("click"))):b.find('[rownum="'+
f+'"]').addClass("jfgrid-head-cell-selected").addClass("jfgrid_selected_"+c.id)),console.log(a.attr("role"),"$et")):(b.find(h).removeClass("jfgrid-head-cell-selected").removeClass("jfgrid_selected_"+c.id),b.find('[rownum="'+f+'"]').addClass("jfgrid-head-cell-selected").addClass("jfgrid_selected_"+c.id));if(c.onSelectRow)c.onSelectRow(e.jfGrid.getSelectedRow(b))},selectAllRow:function(b,a,c){a.is(":checked")?b.find('.jfgrid-tool-cell [role="checkbox"]').not(":checked").trigger("click"):(c._cancelallcb||
b.find('.jfgrid-tool-cell [role="checkbox"]:checked').trigger("click"),c._cancelallcb=!1)},sortCol:function(b,a){b=b.attr("path");b=e.jfGrid.getHeadCell(b,a.headData);if("datacol"==b.type&&b.sort&&a.isPage){var c;a.sortcell?(a.sortcell.obj.find(".jfgrid-heed-sort").hide(),b==a.sortcell?(c=a.sortcell.obj.find(".jfgrid-heed-sort .active"),c.removeClass("active"),c.hasClass("fa-caret-up")?(a.sortcell.obj.find(".jfgrid-heed-sort .fa-caret-down").addClass("active"),c=!1):(a.sortcell.obj.find(".jfgrid-heed-sort .fa-caret-up").addClass("active"),
...
a.id+"_"+b,h='<div class="jfgrid-subgird-cell" for-rownum="rowId" style="width:'+a._leftWidth+"px;height:"+a.subGridHeight+'px;" >',h=h+('<div class="jfgrid_chlidgird" style="width:'+(e("#jfgrid_scrollarea_"+a.id).width()+a._leftWidth)+"px;padding-left:"+a._borderLeftPadding+'px;" ><div class="jfgrid_subgird_left" style="width:'+a._borderLeftPadding+'px;" ></div>');f.after(h+('<div class="jfgrid-chlidgird-content" id="'+c+'"></div>')+"</div></div>");d.after('<div class="jfgrid-data-cell" for-rownum="rowId" style="width:'+
...
f=c.length;e<f;e++)b.find('[rownum="'+("rownum_"+a.id+"_"+c[e].jfgrid_rownum)+'"]').hide(),0<c[e].jfGrid_ChildRows.length&&!c[e]._isclosed&&d(b,c[e].jfGrid_ChildRows)}var f=e("#"+a.id),h=b.parent().parent().attr("rownum"),h=f.find('.jfgrid-hide-cell[rownum="'+h+'"]').attr("datapath"),h=e.jfGrid.getRowDataByPath(a,h);b.hasClass("fa-caret-down")?(h._isclosed=!0,d(f,h.jfGrid_ChildRows),b.removeClass("fa-caret-down"),b.addClass("fa-caret-right")):(h._isclosed=!1,c(f,h.jfGrid_ChildRows),b.removeClass("fa-caret-right"),
b.addClass("fa-caret-down"))},listTotree:function(b,a,c,d){function e(a,b){b=k[b]||[];for(var f=0,h=b.length;f<h;f++){var g=b[f];g.jfGrid_ChildRows=[];e(g.jfGrid_ChildRows,g[c]);a.push(g);d._maprowdatas[g[c]]=g}}var h=[],k={},g={},p={};d._maprowdatas={};b=b||[];for(var l=0,q=b.length;l<q;l++){var m=b[l];g[m[c]]=1;k[m[a]]=k[m[a]]||[];k[m[a]].push(m);1==g[m[a]]?delete p[m[a]]:p[m[a]]=1;1==p[m[c]]&&delete p[m[c]]}for(var n in p)e(h,n);return h},treeTolist:function(b){function a(b){for(var d=0,e=b.length;d<
