 ...
 */
/* 表单验证数据格式验证  */
//document.write("<link href='~/Scripts/jquery.layer/theme/default/layer.css' rel='stylesheet' / >");
//document.write("<script language=javascript src='~/Scripts/jquery.layer/layer.js’></script>");
